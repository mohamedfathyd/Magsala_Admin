...
public class Add_category extends AppCompatActivity {
    ...
    TextInputEditText textInputEditTextprice,textInputEditTextname,textInputEditTextaddress,textInputEditTextphone;
    ...
    public void fetchInfo(){
        progressDialog = ProgressDialog.show(Add_category.this,"جارى تسجيل القسم الجديد","Please wait...",false,false);
        progressDialog.show();
        ...
        Call<ResponseBody> call = apiinterface.getcontacts_add_first_category(textInputEditTextname.getText().toString()
                ,image, Integer.parseInt(textInputEditTextprice.getText().toString()));
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                Toast.makeText(Add_category.this,t.toString(),Toast.LENGTH_LONG).show();
            }
        });
    }
}
