...
import com.khalej.magsala_admin.Adapter.RecyclerAdapter_providers;
...
public class Monitor_provider extends AppCompatActivity {
    Toolbar toolbar;
    ProgressBar progressBar;
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private RecyclerAdapter_providers recyclerAdapter_secondry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_monitor_provider);
    ...
    public void fetchInfo() {
        ...
        call.enqueue(new Callback<List<user_content>>() {
            ...
            public void onResponse(Call<List<user_content>> call, Response<List<user_content>> response) {
                ...
                recyclerAdapter_secondry = new RecyclerAdapter_providers(Monitor_provider.this, contactList);
