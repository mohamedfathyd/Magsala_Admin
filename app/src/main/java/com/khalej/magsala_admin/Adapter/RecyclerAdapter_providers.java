...
import com.khalej.magsala_admin.Activity.MapsActivity;
...
public class RecyclerAdapter_providers extends RecyclerView.Adapter<RecyclerAdapter_providers.MyViewHolder> {
    Typeface myTypeface;
    private Context context;
    List<user_content> contactslist;
     apiinterface_home apiinterface;
    public RecyclerAdapter_providers(Context context, List<user_content> contactslist){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.list_monitor,parent,false);
    ...
    holder.id.setText("اخر تسجيل دخول :" + contactslist.get(position).getLast_login());
        holder.itemView.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View v) {
               Intent intent=new Intent(context, MapsActivity.class);
               intent.putExtra("lati",contactslist.get(position).getLat());
               intent.putExtra("longg",contactslist.get(position).getLog());
